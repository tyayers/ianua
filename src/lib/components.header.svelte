...
<div class="header">
  <span class="header_left_panel1">
    ...
    {#if showMenuButton}
      ...
      <svg class="menu_button" on:click|stopPropagation={menuClick} style="position: relative; top: -3px; left: -4px;" width="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 6H20M4 12H20M4 18H20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
